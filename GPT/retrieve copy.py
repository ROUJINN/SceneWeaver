...
class ObjectRetriever():
    def __init__(self, objaverse_version="2023_09_23"):
        ...
        self.object_retriever = ObjaverseRetriever(self.clip_model, self.clip_preprocess, self.clip_tokenizer, 
                                                   self.sbert_model, self.objaverse_version, self.retrieval_threshold)
