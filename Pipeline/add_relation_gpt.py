...
Each parent_obj can have less than 4 child_obj on the floor. For example, a table can only have chairs as its children.
...
def add_relation(user_demand, ideas, iter, roomtype):
    ...
    with open(
        f"/home/yandan/workspace/infinigen/record_scene/layout_{iter}.json", "r"
    ) as f:
        layout = json.load(f)
